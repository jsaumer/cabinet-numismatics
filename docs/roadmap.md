...
**Status (September 2026): v0.33.1 (single sign-on, and its first-look
fixes) is the latest published release**, with versioned images published to GHCR from each
